...
@Loader.decorate
export default class IfdefLoader extends Loader {
  async run(content: string) {
    ...
    return parse(content, data, verbose, tripleSlash, fileType);
  }
}
...
enum IfType { If, Elif }
export enum FileType { JS, HTML, CSS }

let useTripleSlash: boolean|undefined;
let fileType: FileType;

export function parse(source: string, defs: object, verbose?: boolean, tripleSlash?: boolean, type?: FileType): string {
